...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
           ...
           url : 'https://talentserviceprofile3.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        ...
        $.ajax({
           ...
           url :'https://talentserviceprofile3.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                ...
                                <form className="ui form">
                                    <div className="ui grid">
                                        ...
                                        */}
                                        ...
                                        >
                                            <TalentStatus
                                                jobSeekStatus={this.state.profileData.jobSeekingStatus}
                                                updateProfileData={this.updateWithoutSave}
                                                saveProfileData={this.updateAndSaveData}
                                            />
                                        </FormItemWrapper>
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='https://talentserviceprofile3.azurewebsites.net/profile/profile/updateProfilePhoto'
